...
@section('content')
    <form class=" flex flex-col w-96 m-auto mt-20 text-center border border-black border-solid rounded-md p-3"
        ...
        <div class="flex justify-between	">
          ...
          <div>
              Likes: <input type="text" name="likes" id="likes" value="{{$post->likes}}"
              class="w-11">
          </div>
      </div>
      <div class="mb-2">
