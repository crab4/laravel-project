...
@section('content')
    <form class=" flex flex-col w-96 m-auto mt-20 text-center border border-black border-solid rounded-md p-3"
        ...
        <select multiple id="tags" name="tags[]"
            class="mb-5 bg-gray-50 h-20 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            @foreach ($tags as $tag)
